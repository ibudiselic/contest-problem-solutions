...
class CantorDustEasy {
	...
	int occurrencesNumber(vector <string> pattern, int time) {
        ...
        const int unit = get_cnt(P, pattern);
        if (time == 0) {
            return unit;
        }
...
// BEGIN CUT HERE
	...
	void test_case_1() { string Arr0[] = {"X"}; vector <string> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0]))); int Arg1 = 2; int Arg2 = 16; verify_case(1, Arg2, occurrencesNumber(Arg0, Arg1)); }
	void test_case_2() { string Arr0[] = {"X...X"}; vector <string> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0]))); int Arg1 = 2; int Arg2 = 4; verify_case(2, Arg2, occurrencesNumber(Arg0, Arg1)); }
	void test_case_3() { string Arr0[] = {"XX"}; vector <string> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0]))); int Arg1 = 9; int Arg2 = 0; verify_case(3, Arg2, occurrencesNumber(Arg0, Arg1)); }
	void test_case_4() { string Arr0[] = {"X.X","...","X.."}; vector <string> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0]))); int Arg1 = 1; int Arg2 = 0; verify_case(4, Arg2, occurrencesNumber(Arg0, Arg1)); }
